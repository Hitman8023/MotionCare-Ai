...
export default function Sidebar() {
    const navItems = [
        { to: '/', label: 'Dashboard', icon: <><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /><rect x="14" y="14" width="7" height="7" /></>, badge: null },
    ...
    return (
        <aside className="sidebar">
            ...
            <div className="sidebar-footer" style={{ marginTop: '20px' }}>
                ...
                <p>Session: 00:42:17<br />Exercises: 3 of 5 complete</p>
            </div>
        </aside>
    );
}
